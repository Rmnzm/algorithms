...
def dijkstra_algorithm(graph, start_node):
    ...
    # Мы будем использовать этот словарь,
    # чтобы сэкономить на посещении каждого узла и обновлять его по мере продвижения по графику
    shortest_path = {}
...
def print_result(previous_nodes, shortest_path, start_node, target_node):
    ...
    target_path = f"Найден следующий лучший маршрут с ценностью {shortest_path[target_node]}."
    path_way = " -> ".join(reversed(path))
    return target_path, path_way
